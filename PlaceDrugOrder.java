...
public class PlaceDrugOrder extends BasicFrameDesign implements ActionListener {

	public JLabel head , drugLabel,count,warn1,msg;
	public JComboBox<String> drugList;
	public JTextField dinstock;
	public String drugNameSelected;
	int quantityValue,drugSelctedIndex;
	JButton submit,back,refresh;
	
	public PlaceDrugOrder(String title,String header) throws IOException
	{
		...
		drugLabel.setBounds(200,100,200,40);
		...
		drugList.setBounds(350,100,200,40);
		...
		getContentPane().add(count);
		 ...
		 dinstock=new JTextField(30);
	      ...
	      warn1.setBounds(350,240,170,40);
		...
		submit=new JButton("SUBMIT");
	       ...
	       submit.setBounds(200,380,230,50);
	       ...
	       refresh.setBounds(730,380,220,50);
